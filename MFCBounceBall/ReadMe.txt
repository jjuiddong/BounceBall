================================================================================
    MFC 라이브러리 : MFCBounceBall 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 MFCBounceBall 응용 프로그램을 
만들었습니다.  이 응용 프로그램은 MFC(Microsoft Foundation Classes)의
기본적인 사용법을 보여 주며 응용 프로그램 작성을 위한 출발점을 제공합니다.

이 파일에는 MFCBounceBall 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

MFCBounceBall.vcproj
...
MFCBounceBall.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMFCBounceBallApp 응용 프로그램
    클래스를 선언합니다.

MFCBounceBall.cpp
    응용 프로그램 클래스 CMFCBounceBallApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\MFCBounceBall.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.  이 아이콘은
    주 리소스 파일인 MFCBounceBall.rc에 의해 포함됩니다.

res\MFCBounceBall.rc2
...
res\Toolbar.bmp
    ...
    MFCBounceBall.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 MFCBounceBall.pch와
